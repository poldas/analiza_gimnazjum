...
SELECT sum(uz.punkty) AS punkty
FROM uczen_zadanie AS uz LEFT JOIN zadanie AS z ON z.numer_zadania = uz.numer_zadania
  LEFT JOIN zadanie_obszar_umie AS zou ON zou.numer_zadania = z.numer_zadania
  LEFT JOIN obszar_umiejetnosc AS ou ON zou.id_obszar_umiej = ou.id
WHERE ou.obszar = "I";
